...
const routes: Route[] = [
    route('/api/health', () => import('../api/health')),
    route('/api/auth/signup', () => import('../api/auth/signup')),
    route('/api/auth/login', () => import('../api/auth/login')),
    route('/api/auth/logout', () => import('../api/auth/logout')),
    route('/api/auth/me', () => import('../api/auth/me')),
    route('/api/auth/recover', () => import('../api/auth/recover')),
    route('/api/tasks', () => import('../api/tasks/index')),
    route('/api/tasks/:taskNumber', () => import('../api/tasks/[taskNumber]')),
    route('/api/submissions', () => import('../api/submissions')),
    route('/api/coins/history', () => import('../api/coins/history')),
    route('/api/admin/unlock', () => import('../api/admin/unlock')),
    route('/api/admin/lock', () => import('../api/admin/lock')),
    route('/api/admin/tasks', () => import('../api/admin/tasks/index')),
    route('/api/admin/tasks/:taskNumber', () => import('../api/admin/tasks/[taskNumber]')),
    route('/api/admin/users', () => import('../api/admin/users')),
    route('/api/admin/coins', () => import('../api/admin/coins')),
    route('/api/admin/submissions', () => import('../api/admin/submissions')),
    route('/api/admin/audit', () => import('../api/admin/audit')),
];
