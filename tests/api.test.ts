...
import tasksIndex from '../api/tasks/index';
import taskDetail from '../api/tasks/[taskNumber]';
import submissions from '../api/submissions';
import coinsHistory from '../api/coins/history';
import adminUnlock from '../api/admin/unlock';
import adminTasks from '../api/admin/tasks/index';
import adminTaskItem from '../api/admin/tasks/[taskNumber]';
import adminUsers from '../api/admin/users';
import adminCoins from '../api/admin/coins';
import adminSubmissions from '../api/admin/submissions';
